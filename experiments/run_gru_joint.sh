...
# --- CONFIGURATION ---
ENV="pick_place" # Options: highway, pick_place
STATE=false   # Options: true (state), false (pixels)
...
RESULTS_DIR="results/gru_joint/$RUN_NAME"
PLOTS_DIR="plots/gru_joint/$RUN_NAME"
...
VANILLA_DIR="$RESULTS_DIR/vanilla_freeze_joint_gru_${ENV}_seed${SEED}"
CAC_DIR="$RESULTS_DIR/concept_actor_critic_joint_gru_${ENV}_seed${SEED}"
GVF_DIR="$RESULTS_DIR/gvf_joint_gru_${ENV}_seed${SEED}"
