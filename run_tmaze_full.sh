...
# 6  cbm        × {gru, stacked, none} × {online}       × {frozen, coupled}
# 12 concept_ac × {gru, stacked, none} × {online, none} × {frozen, coupled}
# ── total: 19 runs
#
# Key comparisons:
...
#   gru vs stacked vs none                            — does temporal memory help?
...
echo "========================================"
echo "TMazeEnv architecture sweep (19 runs)"
...
# ---------------------------------------------------------------------------
# cbm × {gru, stacked, none} × {online} × {frozen, coupled}
# ---------------------------------------------------------------------------
for TEMPORAL in gru stacked none; do
...
# ---------------------------------------------------------------------------
# concept_ac × {gru, stacked, none} × {online, none} × {frozen, coupled}
# ---------------------------------------------------------------------------
for TEMPORAL in gru stacked none; do
