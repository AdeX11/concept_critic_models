...
BENCHMARK_REGISTRY: Dict[str, BenchmarkSpec] = {
    ...
    "highway_state": BenchmarkSpec(
        benchmark_id="highway_state",
        env_name="highway_state",
        family="highway",
        variant="state",
        role="state",
        capability_tags=("event_memory", "diagnostic"),
        difficulty_level="medium",
        canonical_total_timesteps=300_000,
        canonical_num_labels=500,
        canonical_query_num_times=1,
    ...
    "highway": BenchmarkSpec(
        benchmark_id="highway",
        env_name="highway",
        family="highway",
        variant="hidden",
        role="hidden",
        capability_tags=("event_memory", "pixel"),
        difficulty_level="medium",
        canonical_total_timesteps=800_000,
        canonical_num_labels=500,
        canonical_query_num_times=1,
