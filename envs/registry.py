...
from .lunar_lander import (
    ...
    make_lunar_lander_pos_only_concept_env,
...
ENV_REGISTRY: Dict[str, EnvFactorySpec] = {
    ...
    "lunar_lander_pos_only_concept": EnvFactorySpec(
        env_name="lunar_lander_pos_only_concept",
        make_vec=make_lunar_lander_pos_only_concept_env,
        make_single=make_single_lunar_lander_pos_only_concept_env,
        pass_n_stack=False,
        state_like=True,
    ),
